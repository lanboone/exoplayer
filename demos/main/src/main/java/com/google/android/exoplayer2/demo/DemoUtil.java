...
public final class DemoUtil {
  ...
  public static RenderersFactory buildRenderersFactory(
      Context context, boolean preferExtensionRenderer,AudioProcessor audioProcessor) {
    @DefaultRenderersFactory.ExtensionRendererMode
    int extensionRendererMode =
        useExtensionRenderers()
            ? (preferExtensionRenderer
    ...
    DefaultRenderersFactory renderersFactory = new DefaultRenderersFactory(context.getApplicationContext()){
      ...
      protected void buildAudioRenderers(Context context,
        ...
        AudioProcessor[] audioProcessors = new AudioProcessor[1];
        audioProcessors[0] = audioProcessor;
        out.add(new MediaCodecAudioRenderer(context,mediaCodecSelector,enableDecoderFallback,eventHandler,eventListener,
            new DefaultAudioSink(AudioCapabilities.getCapabilities(context),audioProcessors))); //enableFloatOutput

        out.add(new FfmpegAudioRenderer(null,null,audioProcessors));
